...
public class jf_buscar_paciente_historial extends JDialog {
	...
	public static void main(String[] args) {
		try {
			jf_buscar_paciente_historial dialog = new jf_buscar_paciente_historial();
	 ...
	 * Create the dialog.
	 */
	public jf_buscar_paciente_historial() {
		setModal(true);
