...
public class jd_buscar_doctor_editar extends JDialog {
	...
	public jd_buscar_doctor_editar() {
		try {
			...
			consultasDB.mostrar_filtro_doctor_editar(this);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		setIconImage(Toolkit.getDefaultToolkit().getImage(jd_buscar_doctor_editar.class.getResource("/iconos_menus/dentilaxIcono.png")));
		...
		btn_filtrar_toggle.setSelectedIcon(new ImageIcon(jd_buscar_doctor_editar.class.getResource("/iconos_submenus/nofiltrar.png")));
		btn_filtrar_toggle.setIcon(new ImageIcon(jd_buscar_doctor_editar.class.getResource("/iconos_submenus/iconoFiltrar.png")));
			...
			buttonPane.setLayout(null);
			{
				...
				btn_editar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
	                    ...
	                    try {
	                    	dispose();
	                    	conection.consulta_doctor_cargar(nombre, apellidos);
						} catch (SQLException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						} 
