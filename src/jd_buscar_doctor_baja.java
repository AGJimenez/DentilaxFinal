...
public class jd_buscar_doctor_baja extends JDialog {
	...
	public jd_buscar_doctor_baja() {
		...
		{
			JLabel lbl_buscar_doctor_baja = new JLabel("INTRODUCE UN DNI PARA DAR DE BAJA");
			lbl_buscar_doctor_baja.setFont(new Font("Barlow", Font.BOLD, 20));
			lbl_buscar_doctor_baja.setBounds(35, 35, 350, 42);
			contentPanel.add(lbl_buscar_doctor_baja);
		}
		{
