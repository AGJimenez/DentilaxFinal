...
public class jd_pedido_menudr extends JDialog {
    ...
    public jd_pedido_menudr() {
    	try {
			//CON ESTO MOSTRAMOS LOS COMBO BOX
			consultasDB.mostrar_filtro_inventario_menu_dr(this);
        ...
        panel_contened.setBounds(9, 96, 710, 43);
        ...
        buttonPane.setLayout(null);
                ...
                btn_salir.setBounds(542, 0, 153, 43);
        ...
        scrollPane.setBounds(12, 150, 707, 247);
		...
		panel_contened_1.setBounds(251, 31, 417, 53);
		...
		btn_filtrar_toggle.setBounds(678, 38, 47, 43);
