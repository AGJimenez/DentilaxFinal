...
public class jd_buscar_pedido_encontrado extends JDialog {
	...
	public static void main(String[] args) {
		try {
			jd_buscar_pedido_encontrado dialog = new jd_buscar_pedido_encontrado();
	 ...
	 * Create the dialog.
	 */
	public jd_buscar_pedido_encontrado() {
		setTitle("Paciente encontrado");
		setIconImage(Toolkit.getDefaultToolkit().getImage(jd_buscar_pedido_encontrado.class.getResource("/iconos_menus/dentilaxIcono.png")));
