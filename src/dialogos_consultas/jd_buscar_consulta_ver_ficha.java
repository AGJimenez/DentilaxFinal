...
public class jd_buscar_consulta_ver_ficha extends JDialog {
	...
	public static void main(String[] args) {
		try {
			jd_buscar_consulta_ver_ficha dialog = new jd_buscar_consulta_ver_ficha();
	 ...
	 * Create the dialog.
	 */
	public jd_buscar_consulta_ver_ficha() {
		setModal(true);
