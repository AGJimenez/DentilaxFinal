...
public class jd_mod_consulta extends JDialog {
	JButton okButton;
	...
	public static void main(String[] args) {
		try {
			jd_mod_consulta dialog = new jd_mod_consulta(null);
	...
	public jd_mod_consulta(String id_cita) {
		...
		buscar_icono.setIcon(new ImageIcon(jd_mod_consulta.class.getResource("/iconos_submenus/search.png")));
	...
	/*	calendar.getDayChooser().addPropertyChangeListener(new PropertyChangeListener() {
		...
		lblNewLabel.setIcon(new ImageIcon(jd_mod_consulta.class.getResource("/iconos_menus/fondo (1).png")));
		...
		txt_fecha.setText(fechaFormateada);
	        ...
	        okButton.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	                ...
	                conect.modificarCita(idCita, dniDoc, txt_fecha.getText(), cb_especialidad.getSelectedItem().toString(), " ", dniPac, txt_hora.getText());
	                
	                if (conect.isCitaCorrecta()) {
