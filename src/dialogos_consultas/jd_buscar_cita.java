...
public class jd_buscar_cita extends JDialog {
	...
	public jd_buscar_cita() {
		try {
			...
			consultasDB.mostrar_filtro_cita(this);
		...
		lbl_fecha.setBounds(52, 11, 96, 21);
		...
		lbl_especialidad.setBounds(250, 11, 132, 21);
		...
		lbl_dni_paciente.setBounds(485, 11, 140, 21);
		...
		btn_filtrar_toggle.setSelectedIcon(new ImageIcon(jd_buscar_cita.class.getResource("/iconos_submenus/nofiltrar.png")));
		btn_filtrar_toggle.setIcon(new ImageIcon(jd_buscar_cita.class.getResource("/iconos_submenus/iconoFiltrar.png")));
		btn_filtrar_toggle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(btn_filtrar_toggle.isSelected()) {
					...
					try {
						llenarTabla(conection.filtrar_tabla_buscar_citas(field_filtrado,txt_filtrar.getText().toString()));
